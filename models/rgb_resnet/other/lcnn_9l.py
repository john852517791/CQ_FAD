...
from models.rgb_resnet.basemodel.ori_lcnn import LightCNN_9Layers
...
class Model(nn.Module):
    def __init__(self,args):
        ...
        self.classifier = LightCNN_9Layers()
    
    def forward(self,x,train=False):
        transform_img, sec = self.pretrained(x,train)
        hid,output = self.classifier(transform_img)
