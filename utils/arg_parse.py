...
def f_args_parsed(argument_input = None):
    ...
    # module of dataset
    parser.add_argument('--tl_data_module', type=str, default="models.tl_model")
    ...
    # checkpoint dir
    parser.add_argument('--savedir', type=str, default="./train_log/", help='save model to this direcotry (default ./)')
    ...
    parser.add_argument('--total_step', type=int, default=105700)
    # scheduler
    ...
    # colour num
    parser.add_argument('--colour_num_colours', type=int, default=2)
    parser.add_argument('--colour_temperature', type=float, default=0.01)
    parser.add_argument('--colour_num_heads', type=int, default=4)
    parser.add_argument('--colour_out_channels', type=int, default=256)
    parser.add_argument('--colour_alpha', type=float, default=1.0)
    parser.add_argument('--colour_beta', type=float, default=0.3)
    parser.add_argument('--colour_gamma', type=float, default=1.0)
    
    parser.add_argument('--recon_weight', type=float, default=0.1)
    
    # stable
    parser.add_argument('--using_stable', action='store_true', default=False, help=mes) 
