...
cm_key_file = "/data8/wangzhiyong/project/fakeAudioDetection/rgbFAD/datasets/release_in_the_wild/label.txt"
def eval_to_score_file(score_file, cm_key_file):
    ...
    cm_scores = submission_scores.merge(cm_data[cm_data[2] == "-"], left_on=0, right_on=1, how='inner')  # check here for progress vs eval set
...
if __name__ == "__main__":
    ...
    eval_to_score_file(args.scoreFile, cm_key_file)